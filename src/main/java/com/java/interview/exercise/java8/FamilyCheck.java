...
public class FamilyCheck {
    ...
    public static void main(String[] args) {
        ...
        List<PersonData> listPerson = new ArrayList<>(Arrays.asList(
        ...
        /*        //Collections.sort(listPerson, Comparator.comparing(PersonData::getFirstName));
        Comparator<PersonData> test = Comparator.comparing(a->a.getFirstName());
        test = test.thenComparing(e->e.getLastName());

        listPerson.removeIf(d->d.getFirstName().equalsIgnoreCase("Henok"));
        System.out.println(listPerson);
        //System.out.println(listPerson);
        //listPerson.removeIf(a->a.getFirstName().equalsIgnoreCase("Zewdie"));*/
